...
exports.signin = async (req,res) => {
    ...
    try {
        ...
        if (user) {
            ...
            const {_id, firstname, lastname, email, gender, dob, mobile, address, role} = user;
            return res.json({token, user: {_id, firstname, lastname, email, gender, dob, mobile, address, role}})
        }
        else{
            res.status(400).json({
